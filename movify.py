...
def create_animated_gif(directory: str, output_filename: str, duration: int = 500, num_images: int = 10) -> None:
    """
    ...
    image_files: List[str] = [f"{directory}/example_{i}.png" for i in range(num_images)]
...
if __name__ == "__main__":
    create_animated_gif('images', 'creatures2.gif', 600, 30)
